...
in
{
  ...
  hatsune = nixpkgs.lib.nixosSystem {
    specialArgs = { inherit self inputs username; };

    modules = [
      (import ./../../hosts/hatsune/hardware-configuration.nix)
    ]
    ++ [ (import ./../../hosts/hatsune/packages.nix) ]
    ++ [ (import ./../../hosts/hatsune/user.nix) ]
    ++ [ (import ./../../hosts/hatsune/services) ]
    ++ [ (import ./../../hosts/hatsune/program.nix) ]
    ++ [ (import ./../../hosts/hatsune/network.nix) ]
    ++ [ (import ./../../hosts/hatsune/envs.nix) ]
    ++ [ (import ./../../hosts/hatsune/xdg.nix) ]
    ++ [ (import ./configuration.nix) ]
    ++ [ (import ./network.nix) ]
    ++ [ (import ./system.nix) ]
    ++ [ (import ./fonts.nix) ]
  ...
  minipc = nixpkgs.lib.nixosSystem {
    ...
    ++ [ (import ./../../hosts/minipc/program.nix) ]
    ++ [ (import ./configuration.nix) ]
